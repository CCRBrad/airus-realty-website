...
const navItems = [
  ...
  },
  {
    ...
    children: [
      { label: 'New Agent Guide', href: '/learning-center/new-agent-guide' },
      { label: 'Listing Growth', href: '/learning-center/listing-growth' },
      { label: 'Buyer Conversion', href: '/learning-center/buyer-conversion' },
      { label: 'Social Media Strategy', href: '/learning-center/social-media-strategy' },
      { label: 'Market Insights', href: '/learning-center/market-insights' },
      { label: 'Buyer Education', href: '/learning-center/buyer-education' },
      { label: 'Seller Education', href: '/learning-center/seller-education' },
    ],
  },
  {
    label: 'Culture',
